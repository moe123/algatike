...
// COMPLEX*16 FUNCTION ZCDOTU(N,CX,INCX,CY,INCY)
 ...
 * ) CFN_EOI
 *
 * \brief  Forms the dot product of two complex vectors. ZCDOTU = X ^ H * Y
...
(
	...
	CFN_ZCMPLX_DECL(ZCDOTU, 0.0, 0.0) CFN_EOI

	CFN_IF (N CFN_LE 0) CFN_RETURN ZCDOTU CFN_EOI
	...
	ZCDOTU = CTEMP CFN_EOI

	CFN_RETURN ZCDOTU CFN_EOI
	CFN_END
