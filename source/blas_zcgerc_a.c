...
// SUBROUTINE ZCGERC_A(M,N,ALPHA,X,INCX,Y,INCY,A,LDA)
...
(
	...
	CFN_IF (INFO CFN_NE 0) CFN_THEN
		CFN_CALL CFN_XERBLA("ZCGERC_A", INFO) CFN_EOI
		CFN_RETURN CFN_EOI
	CFN_END_IF
