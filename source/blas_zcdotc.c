...
// COMPLEX*16 FUNCTION ZCDOTC(N,CX,INCX,CY,INCY)
 ...
 * ) CFN_EOI
 *
 * \brief  Forms the dot product of two complex vectors. ZCDOTC = X ^ H * Y
...
(
	...
	CFN_ZCMPLX_DECL(ZCDOTC, 0.0, 0.0) CFN_EOI

	CFN_IF (N CFN_LE 0) CFN_RETURN ZCDOTC CFN_EOI
	...
	ZCDOTC = CTEMP CFN_EOI

	CFN_RETURN ZCDOTC CFN_EOI
	CFN_END
