...
// COMPLEX*16 FUNCTION ZDOTU(N,CX,INCX,CY,INCY)
 ...
 * ) CFN_EOI
 *
 * \brief  Forms the dot product of two complex vectors. ZDOTU = X ^ H * Y
...
(
	...
	CFN_ZCMPLX_DECL(ZDOTU, 0.0, 0.0) CFN_EOI

	CFN_IF (N CFN_LE 0) CFN_RETURN ZDOTU CFN_EOI
